      ...
      <Tab.Screen 
        ...
        options={{ 
          ...
          tabBarIcon: ({ color, size, focused}) => {
            ...
            if(focused){ // Se estiver na tela...
              return <MaterialCommunityIcons name="calendar-edit" size={size} color={"#6F7BF7"} />
            }
            else return <MaterialCommunityIcons name="calendar-plus" size={size} color={"#6F7BF7"} />
          }
        }}/>
      ...
      <Tab.Screen 
        ...
        options={{ 
          ...
          tabBarIcon: ({ color, size, focused}) => {
            ...
            else return <Ionicons name="home-outline" size={size} color={"#6F7BF7"} />
          }
        }} />
      ...
      <Tab.Screen 
        ...
        options={{ 
          ...
          tabBarIcon: ({ color, size, focused}) => {
            ...
            else return <Ionicons name="person-outline" size={size} color={"#6F7BF7"} />
          }
        }} />
